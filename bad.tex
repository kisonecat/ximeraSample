...
Arc Length = $\displaystyle\int_{\answer{0}}^{\answer{2\pi}} \sqrt{1+{\answer{\cos(x)}^2}} \approx \answer{7.64}$ (Evaluate the arc length to 2 decimal places with technology)
